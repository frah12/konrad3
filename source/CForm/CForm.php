...
* @package LydiaCore
*
* Modified by Fredrik Åhman, references to CLydia::Instance changed to CKonrad
*/
...
*/
  public function __construct($name, $attributes=array()) {
    ...
    if(is_callable('CKonrad::Instance()')) {
      $this->characterEncoding = CKonrad::Instance()->config['character_encoding'];
    } else {
